...
public interface IDocumentNumberService
{
    ...
    Task<string> NextChargeAsync(CancellationToken cancellationToken = default);
    Task<string> NextCommandeProductionAsync(CancellationToken cancellationToken = default);
}
